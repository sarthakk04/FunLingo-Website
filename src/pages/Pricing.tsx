            ...
            {pricingPlans.map((plan, index) => (
              <div
                ...
                className={`flex flex-col p-6 sm:p-8 rounded-2xl border backdrop-blur-sm transition-all duration-500 group hover:scale-105 hover:shadow-2xl ${
                  plan.popular
                    ? "border-brandblue-light bg-[rgba(2,91,207,0.1)] relative shadow-lg shadow-blue-500/20 scale-105"
                    : "border-[#ffffff1a] bg-[rgba(255,255,255,0.05)] hover:shadow-blue-500/10"
                } animate-fade-in-up`}
                style={{ animationDelay: `${400 + index * 200}ms` }}
              >
                {plan.popular && (
                  <Badge className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[linear-gradient(135deg,rgba(2,91,207,1)_0%,rgba(0,145,189,1)_100%)] border-0 px-4 py-1.5 hover:scale-110 transition-transform duration-300">
                ...
                <ul className="flex flex-col gap-3 mb-8 flex-grow">
                  {plan.features.map((feature, featureIndex) => (
                    ...
                    >
                      <svg
                        className="w-5 h-5 text-brandlime-green mt-0.5 flex-shrink-0 group-hover/feature:scale-110 transition-transform duration-300"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                      ...
                      <span className="font-body-normal-regular text-textwhite group-hover/feature:text-transparent group-hover/feature:bg-clip-text group-hover/feature:bg-gradient-to-r group-hover/feature:from-[#73d0b9] group-hover/feature:to-[#0091bd] transition-all duration-300">
                        {feature}
                      </span>
                    </li>
                  ))}
                ...
                <Button
                  className={`w-full h-12 px-6 py-3 rounded-lg transition-all duration-300 group/btn overflow-hidden relative ${
                    plan.popular
                      ? "bg-[linear-gradient(135deg,rgba(2,91,207,1)_0%,rgba(0,145,189,1)_100%)] hover:shadow-lg hover:shadow-blue-500/30"
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                >
                  <h3 className="font-body-normal-medium text-textwhite mb-2 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-[#73d0b9] group-hover:to-[#0091bd] transition-all duration-300">
                    {faq.question}
                  </h3>
                  <p className="font-body-normal-regular text-textbody group-hover:text-textwhite transition-colors duration-300">
                    {faq.answer}
